...
export default function Page() {
    const tabs: PageTab[] = [
        { label: 'OEE (设备综合效率)', href: '/efficiency/oee', icon: <Zap size={14} />, active: true },
    ...
    return (
        <StandardPageLayout
            ...
            description="Monitor machine availability, performance, and quality metrics."
            icon={<Zap size={24} />}
            tabs={tabs}
        >
            <div className="flex flex-col items-center justify-center py-20 text-slate-400">
                <p className="text-lg font-medium">OEE (设备综合效率)</p>
