...
metrics_days AS (
    SELECT 
        ...
        CASE 
            ...
            ELSE ROUND(
                MAX(0, CAST(TrackOutTime - LT_StartTime AS FLOAT) - (CAST(LNW_Sec AS FLOAT) / 86400.0)), 2
            )
        END AS "LT(d)",
        ...
        CASE 
            ...
            ELSE ROUND(
                MAX(0, CAST(TrackOutTime - PT_StartTime AS FLOAT) - (CAST(PNW_Sec AS FLOAT) / 86400.0)), 2
            )
        END AS "PT(d)",
